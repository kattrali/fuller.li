...
.. image:: https://www.gravatar.com/avatar/d200a17dd269fd4001bacb11662dab4b.png?s=300
    :alt: Kyle Fuller
    :width: 150px
    :height: 150px
    :align: right
...
and iPad. Founder of `Cocode <https://cocode.org/>`_. I'm `@kylefuller
...
`CocoaPods <https://cocoapods.org/>`_, along with `many others
...
* IRC Client: `znc <http://wiki.znc.in/>`_, `weechat <http://weechat.org/>`_,
  `Palaver <https://palaverapp.com/>`_
